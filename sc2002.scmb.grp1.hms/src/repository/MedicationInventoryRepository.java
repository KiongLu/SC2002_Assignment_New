...
public class MedicationInventoryRepository {
    private static final String FILE_PATH_MEDICATION_INVENTORY = "src/data/MedicationInventory.csv";
    private static final String FILE_PATH_REPLENISHMENT_REQUESTS = "src/data/ReplenishmentRequests.csv";
